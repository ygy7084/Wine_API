...
router.delete('/', function (req, res) {
  ...
  _async2.default.waterfall([function (cb) {
    ...
    _models.Customer.bulkWrite(CustomerBulk).then(function (r) {
      cb(null);
    }).catch(function (e) {
      cb(null);
    });
    ...
    _models.Shop.bulkWrite(ShopBulk).then(function (r) {
      cb(null);
    }).catch(function (e) {
      cb(null);
    });
  }, function (cb) {
    _models.Account.bulkWrite(AccountBulk).then(function (r) {
      cb(null);
    }).catch(function (e) {
      cb(null);
    });
